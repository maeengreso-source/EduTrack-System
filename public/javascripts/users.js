...
document.querySelectorAll(".btn-view").forEach((button) => {
  button.addEventListener("click", async () => {
    try {
      ...
      document.getElementById("viewProfileImage").src = user.profile_image
      ...
      document.getElementById("view_middle_name").value =
        user.middle_name || "-";
      ...
      document.getElementById("view_birthdate").value = user.birthdate
      ...
      document.getElementById("view_contact").value =
        user.contact_number || "-";
      ...
      document.getElementById("view_last_login").value = user.last_login
